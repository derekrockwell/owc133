...
describe Refinery do
  describe "VolunteerCategories" do
    describe "Admin" do
      describe "volunteer_categories" do
        ...
        describe "volunteer_categories list" do
          ...
          it "shows two items" do
            visit refinery.volunteer_categories_admin_volunteer_categories_path
        ...
        describe "create" do
          ...
          context "valid data" do
            it "should succeed" do
              ...
              Refinery::VolunteerCategories::VolunteerCategory.count.should == 1
            end
          end
          ...
          context "invalid data" do
            it "should fail" do
              ...
              Refinery::VolunteerCategories::VolunteerCategory.count.should == 0
            end
          end
